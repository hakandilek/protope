...
public class PrintModeDialog extends Dialog {
	...
	protected void configureShell(Shell newShell) {
		newShell.setText(ProtopeMessages.PrintDialog_Title);
	...
	protected Control createDialogArea(Composite parent) {
		...
		tile.setText(ProtopeMessages.PrintDialog_Tile);
		tile.setSelection(true);

		fitPage = new Button(composite, SWT.RADIO);
		fitPage.setText(ProtopeMessages.PrintDialog_Page);

		fitWidth = new Button(composite, SWT.RADIO);
		fitWidth.setText(ProtopeMessages.PrintDialog_Width);

		fitHeight = new Button(composite, SWT.RADIO);
		fitHeight.setText(ProtopeMessages.PrintDialog_Height);
