...
public class WLinkEditManager extends DirectEditManager {
	...
	public WLinkEditManager(GraphicalEditPart source,
	...
	protected void initCellEditor() {
		// update text
		WLinkFigure figure = (WLinkFigure) getEditPart().getFigure();
