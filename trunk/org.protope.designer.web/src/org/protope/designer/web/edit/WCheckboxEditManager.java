...
public class WCheckboxEditManager extends DirectEditManager {
	...
	public WCheckboxEditManager(GraphicalEditPart source,
	...
	protected void initCellEditor() {
		// update text
		WCheckboxFigure figure = (WCheckboxFigure) getEditPart().getFigure();
