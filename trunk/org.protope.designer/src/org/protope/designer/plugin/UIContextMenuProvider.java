...
public class UIContextMenuProvider
	extends org.eclipse.gef.ContextMenuProvider
{

private ActionRegistry actionRegistry;

public UIContextMenuProvider(EditPartViewer viewer, ActionRegistry registry) {
	super(viewer);
...
public void buildContextMenu(IMenuManager manager) {
	...
	// Alignment Actions
	MenuManager submenu = new MenuManager(ProtopeMessages.AlignmentAction_AlignSubmenu_ActionLabelText);
