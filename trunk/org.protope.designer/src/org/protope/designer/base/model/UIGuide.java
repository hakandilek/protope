...
public class UIGuide implements Serializable {
	...
	private Map<UIElementPart, Integer> map;
	 ...
	 *            on a vertical ruler)
	 */
	public UIGuide(boolean isHorizontal) {
	 ...
	 */
	public void attachPart(UIElementPart part, int alignment) {
		Map<UIElementPart, Integer> m = getMap();
		if (m.containsKey(part) && getAlignment(part) == alignment)
			return;

		m.put(part, alignment);
		UIGuide parent = isHorizontal() ? part.getHorizontalGuide() : part
				.getVerticalGuide();
	 ...
	 */
	public void detachPart(UIElementPart part) {
		Map<UIElementPart, Integer> m = getMap();
	 ...
	 * {@link org.eclipse.gef.examples.logicdesigner.edit.BaseXYLayoutEditPolicy LogicXYLayoutEditPolicy}
	 ...
	 * @see org.eclipse.gef.examples.logicdesigner.edit.BaseXYLayoutEditPolicy#createChangeConstraintCommand(ChangeBoundsRequest,
	 *      EditPart, Object)
	 */
	public int getAlignment(UIElementPart part) {
		Map<UIElementPart, Integer> m = getMap();
		Integer i = m.get(part);
		if (i != null)
			return i;
		return -2;
	}
	 ...
	 *         Integers
	 */
	public Map<UIElementPart, Integer> getMap() {
		if (map == null) {
			map = new Hashtable<UIElementPart, Integer>();
		}
		return map;
	}
	 ...
	 */
	public Set<UIElementPart> getParts() {
		Map<UIElementPart, Integer> m = getMap();
		return m.keySet();
	}
