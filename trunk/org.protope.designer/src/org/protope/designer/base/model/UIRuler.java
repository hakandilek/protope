 ...
 * @author Pratik Shah
 */
public class UIRuler implements Serializable {
	...
	private List<UIGuide> guides = new ArrayList<UIGuide>();

	public UIRuler(boolean isHorizontal) {
		this(isHorizontal, RulerProvider.UNIT_PIXELS);
	}

	public UIRuler(boolean isHorizontal, int unit) {
		horizontal = isHorizontal;
		setUnit(unit);
	}

	public void addGuide(UIGuide guide) {
	...
	public void removeGuide(UIGuide guide) {
