...
public class WLabelEditManager extends DirectEditManager {
	...
	public WLabelEditManager(GraphicalEditPart source,
	...
	protected void initCellEditor() {
		// update text
		WLabelFigure figure = (WLabelFigure) getEditPart().getFigure();
