...
public class WTableEditManager extends DirectEditManager {
	...
	public WTableEditManager(GraphicalEditPart source,
	...
	protected void initCellEditor() {
		// update text
		WTableFigure figure = (WTableFigure) getEditPart().getFigure();
		// update font
		ZoomManager zoomMgr = (ZoomManager) getEditPart().getViewer()
				.getProperty(ZoomManager.class.toString());
		if (zoomMgr != null) {
